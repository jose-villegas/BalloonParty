...
namespace NaughtyAttributes.Editor
{
	...
	{
		// LOCAL PATCH (see Packages/com.dbrizov.naughtyattributes-x/PATCH.md): Unity 6000.4 made
		// Object.GetInstanceID() obsolete-as-error in favour of GetEntityId(). Upstream 2.2.1 has
		// no fix, so every EditorPrefs key that used the instance id routes through here instead.
