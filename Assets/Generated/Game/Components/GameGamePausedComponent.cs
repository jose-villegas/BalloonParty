...
public partial class GameContext {
    ...
    public GameEntity gamePausedEntity { get { return GetGroup(GameMatcher.GamePaused).GetSingleEntity(); } }

    public bool isGamePaused {
        get { return gamePausedEntity != null; }
        set {
            var entity = gamePausedEntity;
            if (value != (entity != null)) {
                if (value) {
                    CreateEntity().isGamePaused = true;
                } else {
                    entity.Destroy();
                }
            }
