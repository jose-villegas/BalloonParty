...
namespace BalloonParty.Tests.Game
{
    ...
    public class RegisterAudioTests
    {
        ...
        public void RegisterAudio_ValidVoicePrefab_RegistersSoundPlayerAndMixerRouter()
        {
            ...
            var mixerSettings = ScriptableObject.CreateInstance<AudioMixerSettings>();
            var builder = new ContainerBuilder();
            ...
            finally
            {
                ...
                Object.DestroyImmediate(mixerSettings);
            }
        }
        ...
        [Test]
        public void RegisterAudio_NullMixerSettings_StillRegistersAWorkingIAudioMixerSettings()
        {
            var prefab = _voiceGo.AddComponent<AudioSourceVoice>();
            var builder = new ContainerBuilder();
