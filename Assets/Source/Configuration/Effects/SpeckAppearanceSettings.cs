...
namespace BalloonParty.Configuration.Effects
{
    ...
    internal class SpeckAppearanceSettings : ISpeckAppearanceSettings
    {
        ...
        [Tooltip("Base scene-light response (0 = specks ignore light, stay emissive; 1 = fully lit, " +
                 "local color replaces at full boost; >1 = picks up local light color more eagerly " +
                 "(inner blend saturates faster)). Colour looks blend toward their own value by heat.")]
