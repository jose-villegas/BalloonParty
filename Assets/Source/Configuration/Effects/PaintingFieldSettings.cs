...
namespace BalloonParty.Configuration.Effects
{
    ...
    internal sealed class PaintingFieldSettings : ScriptableObject, IPaintingFieldSettings
    {
        ...
        [SerializeField] private PaintProfile[] _stampProfiles = new[]
        {
            ...
            new PaintProfile { Sources = PaintSource.ToughBreathing, Radius = 0.25f, Opacity = 0.15f, ColorMode = PaintColorMode.Palette, PaletteColorName = "Tough", CustomColor = Color.white },
            ...
            new PaintProfile { Sources = PaintSource.Bomb, Radius = 0.8f, Opacity = 0.6f, ColorMode = PaintColorMode.Dynamic, PaletteColorName = "", CustomColor = Color.white },
        };
