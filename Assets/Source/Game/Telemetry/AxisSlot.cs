namespace BalloonParty.Game.Telemetry
{
    ...
    // declared in MetricCatalog, not one array per axis kind (see the AxisSlot row in this folder's
    // README). Without this, Deflects and Pops — which share the BalloonType axis
