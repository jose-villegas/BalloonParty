...
| **Shield** | Shield icon, tinted to host color | Grants the active projectile +1 bounce shield; a rainbow holder also buffs it iridescent + piercing + double-speed until the next wall bounce | N/A — no damage dealt |
| **Snipe** | Snipe icon, tinted to host color | Doubles the active projectile's flight speed until it next loses a shield to a wall (applies `SpeedProjectileBuff`) | N/A — no damage dealt |
