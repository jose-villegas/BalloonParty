...
namespace BalloonParty.Slots.Capabilities
{
    public interface IHasScoreColor
    {
        ...
        ///     scatter implementers (Tough/BubbleCluster/Unbreakable) confine their random split to these
        ///     so completing a colour never wastes points on it. Single-colour attributions ignore it.
        /// </summary>
