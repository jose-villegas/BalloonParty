...
namespace BalloonParty.Shared.Animation
{
    ...
    internal static class VectorMathHelper
    {
        ...
        /// </summary>
        internal static Vector3 Centroid(IReadOnlyList<Vector3> points, int count)
        {
        ...
        /// </summary>
        internal static float BoundingRadius(IReadOnlyList<Vector3> points, int count, Vector3 center)
        {
            var maxDist = 0f;
            for (var i = 0; i < count; i++)
            {
